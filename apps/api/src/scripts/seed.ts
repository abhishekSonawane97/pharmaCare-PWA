...
const SEED_MEDICINES = [
  { name: 'Paracetamol 500mg', content: 'Acetaminophen', purchasePrice: 18, mrp: 32, discountedPrice: 28, location: 'Front counter', type: 'tab', addedFrom: 'manual' },
  { name: 'Amoxicillin 500mg', content: 'Amoxicillin trihydrate', purchasePrice: 43, mrp: 68, discountedPrice: 62, location: 'Rack B-2', type: 'cap', addedFrom: 'manual' },
  { name: 'Metformin 500mg', content: 'Metformin HCl', purchasePrice: 24, mrp: 41, discountedPrice: 37, location: 'Rack A-1', type: 'tab', addedFrom: 'bill' },
  { name: 'Atorvastatin 20mg', content: 'Atorvastatin calcium', purchasePrice: 58, mrp: 96, discountedPrice: 86, location: 'Rack A-3', type: 'tab', addedFrom: 'manual' },
  { name: 'Cetirizine 10mg', content: 'Cetirizine HCl', purchasePrice: 12, mrp: 22, discountedPrice: 20, location: 'Front counter', type: 'tab', addedFrom: 'manual' },
  { name: 'Pantoprazole 40mg', content: 'Pantoprazole sodium', purchasePrice: 36, mrp: 59, discountedPrice: 53, location: 'Rack C-1', type: 'cap', addedFrom: 'bill' },
  { name: 'Telmisartan 40mg', content: 'Telmisartan', purchasePrice: 48, mrp: 78, discountedPrice: 70, location: 'Rack A-3', type: 'tab', addedFrom: 'manual' },
  { name: 'Azithromycin 500mg', content: 'Azithromycin dihydrate', purchasePrice: 65, mrp: 112, discountedPrice: 100, location: 'Rack B-2', type: 'tab', addedFrom: 'manual' },
  { name: 'Losartan 50mg', content: 'Losartan potassium', purchasePrice: 32, mrp: 54, discountedPrice: 49, location: 'Rack A-3', type: 'tab', addedFrom: 'manual' },
  { name: 'Glimepiride 2mg', content: 'Glimepiride', purchasePrice: 28, mrp: 46, discountedPrice: 41, location: 'Rack A-1', type: 'tab', addedFrom: 'bill' },
  { name: 'Vitamin D3 60K IU', content: 'Cholecalciferol', purchasePrice: 22, mrp: 38, discountedPrice: 34, location: 'Rack D-1', type: 'cap', addedFrom: 'manual' },
  { name: 'Ibuprofen 400mg', content: 'Ibuprofen', purchasePrice: 17, mrp: 28, discountedPrice: 25, location: 'Front counter', type: 'tab', addedFrom: 'manual' },
  { name: 'Omeprazole 20mg', content: 'Omeprazole', purchasePrice: 30, mrp: 49, discountedPrice: 44, location: 'Rack C-1', type: 'cap', addedFrom: 'manual' },
  { name: 'Levothyroxine 50mcg', content: 'Levothyroxine sodium', purchasePrice: 44, mrp: 72, discountedPrice: 65, location: 'Rack A-2', type: 'tab', addedFrom: 'bill' },
  { name: 'Amlodipine 5mg', content: 'Amlodipine besylate', purchasePrice: 19, mrp: 33, discountedPrice: 30, location: 'Rack A-3', type: 'tab', addedFrom: 'manual' },
  { name: 'Salbutamol Inhaler', content: 'Salbutamol sulfate', purchasePrice: 86, mrp: 140, discountedPrice: 126, location: 'Rack E-1', type: 'syrup', addedFrom: 'manual' },
  { name: 'Diclofenac 50mg', content: 'Diclofenac sodium', purchasePrice: 14, mrp: 24, discountedPrice: 22, location: 'Front counter', type: 'tab', addedFrom: 'manual' },
  { name: 'Ranitidine 150mg', content: 'Ranitidine HCl', purchasePrice: 18, mrp: 30, discountedPrice: 27, location: 'Rack C-1', type: 'tab', addedFrom: 'bill' },
  { name: 'Montelukast 10mg', content: 'Montelukast sodium', purchasePrice: 39, mrp: 64, discountedPrice: 58, location: 'Rack E-1', type: 'tab', addedFrom: 'manual' },
  { name: 'Insulin Glargine', content: 'Insulin glargine', purchasePrice: 320, mrp: 480, discountedPrice: 432, location: 'Refrigerator', type: 'syrup', addedFrom: 'manual' },
  { name: 'Clopidogrel 75mg', content: 'Clopidogrel bisulfate', purchasePrice: 52, mrp: 84, discountedPrice: 76, location: 'Rack A-3', type: 'tab', addedFrom: 'manual' },
  { name: 'ORS Sachet', content: 'Oral rehydration salts', purchasePrice: 7, mrp: 12, discountedPrice: 11, location: 'Front counter', type: 'syrup', addedFrom: 'manual' },
];
